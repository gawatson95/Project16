...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(image: UIImage(systemName: "map"), style: .plain, target: self, action: #selector(changeMapType))
        ...
        let washington = Capital(title: "Washington DC", coordinate: CLLocationCoordinate2D(latitude: 38.895111, longitude: -77.036667), info: "Named after George Washington.", website: "https://en.wikipedia.org/wiki/Washington,_D.C.")
    ...
    func mapView(_ mapView: MKMapView, annotationView view: MKAnnotationView, calloutAccessoryControlTapped control: UIControl) {
        ...
        if let wiki = storyboard?.instantiateViewController(withIdentifier: "wiki") as? CapitalWiki {
            wiki.title = capital.title
            wiki.websiteURL = capital.website
    ...
    @objc func changeMapType() {
        let ac = UIAlertController(title: "Map View", message: "Select how you'd like to view the map", preferredStyle: .actionSheet)
